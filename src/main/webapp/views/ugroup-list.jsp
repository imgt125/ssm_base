											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													<a class="blue" href="#"> <i
														...
														href="${ctx }/editUserRole?username=${user.username}"
														data-toggle="modal" data-target="#myModal" title="分配权限">
														<i class="icon-pencil bigger-130"></i>
													</a>
													
													
													<a class="green" href="${ctx }/editUserRole?id=${ugroup.id}"  title="分配用户"> <i
